...
},{"babel-runtime/helpers/class-call-check":14,"babel-runtime/helpers/create-class":15}],2:[function(require,module,exports){
/*jshint esnext:true */
"use strict";
...
var PartyCollection = (function (_Backbone$Collection) {

	/**
  * @param options
  */

	function PartyCollection(options) {
		_classCallCheck(this, PartyCollection);

		_get(_core.Object.getPrototypeOf(PartyCollection.prototype), "constructor", this).call(this, options);
...
var PartyModel = (function (_Backbone$Model) {
	function PartyModel() {
	...
	_inherits(PartyModel, _Backbone$Model);
...
var PartyView = _interopRequire(require("./PartyView"));
  ...
  */
    ...
    */
			...
			value: function renderOne(model) {
				var view = new PartyView({ model: model });
				return view.render();
			}
		},
		_isAnonymous: {
...
var PartyView = (function (_Backbone$View) {
  ...
  */
	...
	function PartyView(options) {
		_classCallCheck(this, PartyView);
		...
		_get(_core.Object.getPrototypeOf(PartyView.prototype), "constructor", this).call(this, options);
	}
