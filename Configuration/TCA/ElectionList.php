...
$GLOBALS['TCA']['tx_easyvotesmartvote_domain_model_electionlist'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_easyvotesmartvote_domain_model_electionlist']['ctrl'],
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, name, number_of_candidates, number_of_answers, internal_identifier, link_to_list, list_number, election, district',
	),
	'types' => array(
